...
# All of the lower and upper bounds here are inclusive,
# and points can only take on positive integer values up to 200.

# In your if statement, assign the result variable to a string
# holding the appropriate message based on the value of points.
...
# but when you submit your answer, only use the original input of points = 174.
